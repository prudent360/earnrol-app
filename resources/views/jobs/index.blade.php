...
<div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
    ...
    <div class="lg:col-span-1 space-y-4">
        ...
        {{-- Application stats --}}
        @php $appliedCount = auth()->user()->jobApplications()->count(); @endphp
        <div class="card border border-[#e05a3a]/20 bg-[#e05a3a]/5">
            <div class="flex items-center gap-2 mb-3">
                <svg class="w-5 h-5 text-[#e05a3a]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                <p class="font-bold text-[#1a1a2e] text-sm">My Applications</p>
            </div>
            <p class="text-3xl font-bold text-[#e05a3a]">{{ $appliedCount }}</p>
            <p class="text-xs text-[#6b7280] mt-1">job{{ $appliedCount === 1 ? '' : 's' }} applied to</p>
        </div>
    </div>
    ...
    <div class="lg:col-span-3 space-y-4">
        ...
        <div class="card hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            ...
            <div class="flex items-center justify-between mt-4 pt-4 border-t border-[#e8eaf0]">
                ...
                <a href="{{ route('jobs.show', $job) }}" class="btn-primary text-sm py-2 px-5">Apply Now</a>
            </div>
        </div>
        @empty
