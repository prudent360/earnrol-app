        ...
        <form action="{{ route('creator.products.update', $product) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="flex items-center justify-between bg-gray-50 rounded-xl p-4">
                ...
                <label class="relative inline-flex items-center cursor-pointer">
                    ...
                    <input type="checkbox" name="affiliate_enabled" value="1" class="sr-only peer" {{ old('affiliate_enabled', $product->affiliateProduct?->affiliate_enabled ?? false) ? 'checked' : '' }}>
            ...
            <div>
                ...
                <input type="number" name="affiliate_commission" id="affiliate_commission" step="0.1" min="0" max="90" class="form-input" value="{{ old('affiliate_commission', $product->affiliateProduct?->commission_percentage ?? '') }}" placeholder="e.g. 20">
