            ...
            @elseif($paymentEnabled)
                ...
                <div x-data="{
                    ...
                    <div class="space-y-2 mt-3">
                        ...
                        <a :href="validCode ? '{{ route('products.bank-transfer', $product) }}?coupon_code=' + encodeURIComponent(validCode) : '{{ route('products.bank-transfer', $product) }}'" class="w-full py-3 rounded-xl text-sm font-bold bg-gray-700 text-white hover:bg-gray-800 transition-colors inline-flex items-center justify-center gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M3 14h18m-9-4v8m-7 0h14a2 2 0 002-2V8a2 2 0 00-2 2v8a2 2 0 002 2z"/></svg>
                            Bank Transfer
                        </a>
                        @endif
                    </div>
