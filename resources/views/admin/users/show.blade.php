...
<div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
    ...
    <div class="flex flex-wrap items-center gap-2">
        ...
        <form method="POST" action="{{ route('admin.users.impersonate', $user) }}">
            @csrf
            <button type="submit" class="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white font-semibold px-4 sm:px-5 py-2 sm:py-2.5 rounded-lg text-sm transition-colors" onclick="return confirm('Login as {{ $user->name }}? You will see the platform from their perspective.')">
