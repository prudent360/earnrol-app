    ...
    <div class="card">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <a href="{{ $cohort->google_meet_link }}" target="_blank" rel="noopener noreferrer"
               class="btn-primary text-sm py-3 px-6 flex-shrink-0">
            ...
            <span class="text-sm text-gray-400 font-medium flex-shrink-0">Starts soon</span>
            @elseif($cohort->status === 'completed')
            <span class="text-sm text-gray-400 font-medium flex-shrink-0">Completed</span>
            @endif
        </div>
    </div>
    @endforeach
