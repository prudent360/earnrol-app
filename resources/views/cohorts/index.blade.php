    ...
    <div class="card">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3 flex-shrink-0">
                ...
                <a href="{{ route('cohorts.discussions', $cohort) }}" class="text-sm font-medium text-emerald-600 hover:underline flex items-center gap-1">
                ...
                <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div class="pt-4 border-t border-gray-100 space-y-3">
                            ...
                            <a href="{{ route('cohorts.discussions', $cohort) }}" class="w-full py-2.5 rounded-xl text-sm font-bold bg-emerald-50 text-emerald-700 hover:bg-emerald-100 transition-colors inline-flex items-center justify-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>
                                Join Discussion
                            </a>
                        </div>
