    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside id="sidebar" class="w-64 bg-[#1a2535] flex flex-col flex-shrink-0 transition-transform duration-300 z-40 fixed inset-y-0 left-0 -translate-x-full lg:relative lg:translate-x-0">
            ...
            <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                ...
                @if(auth()->user()->isAdmin() && !session('impersonator_id'))
                {{-- ==============================
                     ADMIN ONLY — Clean admin view
                ============================== --}}
                ...
                {{-- Users --}}
                <p class="text-[9px] font-bold text-gray-600 uppercase tracking-widest px-4 mt-4 mb-1.5">Users</p>
                ...
                {{-- Content --}}
                <p class="text-[9px] font-bold text-gray-600 uppercase tracking-widest px-4 mt-4 mb-1.5">Content</p>
                ...
                {{-- Revenue --}}
                <p class="text-[9px] font-bold text-gray-600 uppercase tracking-widest px-4 mt-4 mb-1.5">Revenue</p>
                ...
                @elseif(auth()->user()->inCreatorMode())
                {{-- ==============================
                     CREATOR MODE
                ============================== --}}
                ...
                <a href="{{ route('cohorts.index') }}" class="sidebar-link {{ request()->routeIs('cohorts.index') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('products.index') }}" class="sidebar-link {{ request()->routeIs('products.index', 'products.show') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/>
                    </svg>
                    Products
                ...
                <a href="{{ route('memberships.index') }}" class="sidebar-link {{ request()->routeIs('memberships.index', 'memberships.show') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"/>
                    </svg>
                    Memberships
                ...
                <a href="{{ route('memberships.mine') }}" class="sidebar-link {{ request()->routeIs('memberships.mine') ? 'active' : '' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"/>
                    </svg>
                    My Subscriptions
                            ...
                            <div x-show="open" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 translate-y-1"
                                ...
                                <div class="max-h-80 overflow-y-auto">
                                    ...
                                    @php
                                        ...
                                        $dotColor = match($nd['color'] ?? 'blue') {
                                            'green' => 'bg-emerald-400',
                                            'red' => 'bg-red-400',
                                            'yellow', 'amber' => 'bg-amber-400',
                                            default => 'bg-blue-400',
                                        };
                                    @endphp
