...
<body class="bg-[#f5f6fa] font-sans">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        {{-- Sidebar --}}
        <aside id="sidebar" class="w-64 bg-[#1a2535] flex flex-col flex-shrink-0 transition-transform duration-300 z-40 fixed inset-y-0 left-0 lg:relative lg:translate-x-0">
            {{-- Logo --}}
        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden lg:ml-0">
            {{-- Top navbar --}}
            <header class="bg-white border-b border-[#e8eaf0] px-6 py-4 flex items-center justify-between flex-shrink-0">
